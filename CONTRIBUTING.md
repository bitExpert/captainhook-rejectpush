...
If you are working on new features or refactoring [create a proposal](https://github.com/bitExpert/captainhook-rejectpush/issues).
...
2. Fork the repository (https://github.com/bitExpert/captainhook-rejectpush)
...
```console
$ git remote add {username} git@github.com:{username}/captainhook-rejectpush.git
$ git fetch {username}
```
...
To ssh://git@github.com/{username}/captainhook-rejectpush.git
